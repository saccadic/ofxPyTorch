...
meta:
	ADDON_NAME = ofxPyTroch
	ADDON_DESCRIPTION = PyTorch Libraries for openFrameworks.
	ADDON_AUTHOR = Katsuyoshi Hotta
	ADDON_TAGS = "AI" "PyTorch"
	ADDON_URL = https://github.com/saccadic/ofxPyTorch
...
vs:
	...
	ADDON_INCLUDES = src
	ADDON_INCLUDES += libs/libtorch
	ADDON_INCLUDES += libs/libtorch/include
	ADDON_INCLUDES += libs/libtorch/include/torch/csrc/api/include

	ADDON_DATA = asmjit.dll
	ADDON_DATA += c10.dll
	ADDON_DATA += c10_cuda.dll
	ADDON_DATA += cudnn64_7.dll
	ADDON_DATA += fbgemm.dll
	ADDON_DATA += nvToolsExt64_1.dll
